# Generated by Django 4.2.5 on 2023-09-25 19:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('farmer', 'Farmer'), ('supplier', 'Supplier'), ('admin', 'Admin')], default='', max_length=15, verbose_name='Role')),
        ...
        migrations.CreateModel(
            name='Farmer',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='register.customuser')),
            ],
        ),
        migrations.CreateModel(
            name='Supplier',
